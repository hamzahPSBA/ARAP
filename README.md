...
1. Download the cnn_v3.ipynb file from CNN branch
2. Open Google Colab
3. Open new notebook
4. Choose upload notebook
5. Upload cnn_v3.ipynb

How to run Webots world?
1. Download ARAP2.WBT from Webots branch
2. Open Webots
3. Open world in Webots
4. Select ARAP2.WBT
